                  ...
                  <div class="col-sm-12 col-lg-12">
                     <div class="iq-card">
                        ...
                        <div class="iq-card-body">
                           <form id="femaleProductUpdate" name="femaleProductUpdate" action="
                           " method="post">
                                 <div class="form-row">
                                ...
                                <div class="form-row">
                                 ...
                                 <select class="form-control" id="p_category" name = "p_category">
                                    <option>Select female category</option>
                                    <option>female boots</option>
                                    <option>female shoes</option>
                                    <option>female sweatshirts</option>
                                    <option>luxury bags</option>
                                    <option>leather wears</option>
                                    <option>skirts</option>
                                    <option>bum shorts</option>
         ...
         function retrieveProduct(getThis){
            ...
            $.post("retrieveProducts.php", getProduct).done(function(data){
               ...
               if(data !=0 ){ 
                  ...
                  var urlToFile = 'female products/' + data[0] + '.jpg';
         ...
         function updateAccount(){
            ...
            if(productName == "" || productPrice == "" || productCategory == ""){
               alert("Please fill in all the required fields");
                  ...
                  var data = $("form#femaleProductUpdate")[0]; 	
                  var formData = new FormData(data); 
                  if(feedback == true){
                     $.ajax({                                
							url: "processUploadFemaleProduct.php",
							type: 'POST',
							data: formData,
							async: false,
							cache: false,
...
<!-- Mirrored from iqonic.design/themes/vito/html/form-layout.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 18 Sep 2020 13:37:14 GMT -->
</html>