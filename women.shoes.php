...
<div class="grid grid-border header_product" style = "text-align:center">
  ...
  <!-- <div class="grid-item large--four-fifths grid-border--left"> -->
      ...
      <h1 style = "text-align:center; color: black; font-size: 30px; font-style: italic; font-weight: bold; font-family: georgia,sans-serif;padding-top: 20px;" class = "header_product">WOMEN SHOES</h1>
...
<script>
  ...
  $(function() {
    ...
    <?php
      ...
      $sql = "SELECT * FROM female_products WHERE product_categories = 'female shoes' ORDER BY product_id DESC";
