...
<!-- <body id="dresses" class="template-collection" style = " background-image: radial-gradient(#DAA520 10%, #DAA520 15%, #DAA520 60%););" > -->
...
<div class="grid grid-border header_product" style = "text-align:center">
  ...
  <!-- <div class="grid-item large--four-fifths grid-border--left"> -->
      ...
      <h1 style = "text-align:center; color: black; font-size: 30px; font-style: italic; font-weight: bold; font-family: georgia,sans-serif;padding-top: 20px; margin-left: 50px" class = "header_product">LUXURY BAGS</h1>
...
<script>
 ...
 <?php
    ...
    $sql = "SELECT * FROM female_products WHERE product_categories = 'luxury bags' ORDER BY product_id DESC";
