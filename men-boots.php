...
<div class="row mob-header">
  ...
  <div class="col-lg-7 col-sm-4 col-md-6 col-xs-12 top_search">   
      ...
      <div class="tile_search trs_bg" style = "padding-bottom:20px">
        <!-- search form -->
        <form  class="search-form" action="maleSearch.php" method="POST">
                  <input id="search" name = "search" type="text"  placeholder="search here" value = ""/>
              <button type="submit" style = "background-color:black"  title="Search" class="search-btn-bg" id="submit-button" onclick = "clicksSearch()"><span>search</span></button>
  ...
  <!-- shopping cart -->
          <a href="productCart.php">
            ...
            <span class="cart-total-items"><span id="cartQuantity" class="count">0</span> </span>
          </a>
    </div>
...
<div class="grid grid-border header_product" style = "text-align:center">
  ...
  <!-- <div class="grid-item large--four-fifths grid-border--left"> -->
      ...
      <h1 style = "text-align:center; color: black; font-size: 30px; font-style: italic; font-weight: bold; font-family: georgia,sans-serif;padding-top: 20px; margin-left: 50px" class = "header_product">MEN BOOTS</h1>
...
<script>
  ...
  $(function() {
    ...
    $sql = "SELECT * FROM male_products WHERE product_categories = 'men boots' ORDER BY product_id DESC";
    ...
    while($row = mysqli_fetch_array($result)){
      ...
      $productUrl		= "viewMaleProduct.php?productid=".$productId;
      ...
      if($numRow > 0){
          echo "<div class='product product__product-grid-item col-sm-3'>
            ...
            echo "</div>
                <div class='product_title-wrap' style = 'margin-top:20px; text-align:center'>
                  <a class='product_title' style ='font-size:30px;color:black;'>
                    $productName 	
                  </a>
          ...
          <form action='' id='addItemToCartForm' method='' enctype='' class='addToCartForm1'>
              
              <input type='hidden' name='id' value='5309057155' class='btn'/>
              <input type='hidden' id='quantity' name='quantity' value='1'>              
            <button type='button' name='$productId~$pagename' id ='' class='btn btn-primary addToCart' style= 'background-color:black' onclick='addItemCart(this.name)'>
  ...
  <script>
    function addItemCart(getThisname){    
      var username = 'btnData=' + getThisname;
...
moneyFormat = "$ {{amount}}" 
jsondata = "eyJibnRfdGV4dCI6Ilx1MDBhMCIsImJudF90ZXh0X2ZvbnQiOiJhcmlhbCIsImJudF90ZXh0X2ZvbnRzaXplIjoiMTRweCIsImJudF90Z " ></div>
