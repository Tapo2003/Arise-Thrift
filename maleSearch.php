...
<div class="row mob-header">
  ...
  <div class="col-lg-7 col-sm-4 col-md-6 col-xs-12 top_search">   
        ...
        <div class="tile_search trs_bg" style = "padding-bottom:20px">
          <!-- search form -->
              <form id="search_top" class="search-form" action="maleSearch.php" method="POST">
...
<div class="grid grid-border header_product" style = "text-align:center">
  ...
  <!-- <div class="grid-item large--four-fifths grid-border--left"> -->
      ...
      <h1 style = "text-align:center; color: black; font-size: 30px; font-style: italic; font-weight: bold; font-family: georgia,sans-serif;padding-top: 20px; margin-left: 50px" class = "header_product">Search Male Products</h1>
  ...
  $(function() {
    ...
    <?php
      ...
      if(isset($_POST["search"]) && !empty($_POST["search"])){
        ...
        $sql = "SELECT * FROM male_products WHERE product_name  LIKE '%$userInput%' OR brand_name LIKE '%$userInput%' OR product_description LIKE '%$userInput%' ORDER BY product_id DESC";
...
<!-- footer -->
<footer id="footer" style = "background-color:black; padding-bottom:40px;height:200px">
