...
$(document).ready(function(){
  $('[data-toggle="tooltip"]').tooltip();   
    ...
    <?php
      ...
      $sql 	= "SELECT * FROM female_products WHERE product_id ='$getid'";
      $result = mysqli_query($connection,$sql) or die(mysql_error());	
...
<div data-id="1844346307" class="product-1844346307 product-item">
   ...
   <div class="col-sm-6 col-lg-5 product-image">
      ...
      <div class="col-lg-7 col-sm-6">
          ...
          <!-- <span class="shopify-product-reviews-badge" data-id="1844346307"></span> -->
         
          <form action="" method="post" enctype="multipart/form-data" data-id="1844346307" class="addToCartForm product-actions-1844346307">
