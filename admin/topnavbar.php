               ...
               <div class="iq-card shadow-none m-0">
                  <div class="iq-card-body p-0 ">
                     <div class="bg-primary p-3">
                        <!-- <?php
                        // echo "<h5 class='mb-0 text-white line-height'>Hello $username</h5>";
                        ?> -->
                     ...
                     <div class="d-inline-block w-100 text-center p-3">
                        <a class="bg-primary iq-sign-btn" href="signout.php" role="button">Sign out<i class="ri-login-box-line ml-2"></i></a>
                     </div>
                  </div>
               </div>
            </div>
