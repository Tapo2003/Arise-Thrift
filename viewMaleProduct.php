 ...
 <div class="col-lg-3 col-sm-5 col-md-4 col-xs-12"> 
   ...
   <div class="tile_cart trs_bg">
        <a href="productCart.php">
          ...
          <!-- <span class="cart-total-items"><span class="count" id="cartQuantity" name = "cartQuantity">0</span> </span> -->
...
<?php
        ...
        $sql 	= "SELECT * FROM male_products WHERE product_id ='$getid'";
        $result = mysqli_query($connection,$sql) or die(mysql_error());	
...
<!-- center column -->
  ...
  <p id = "addToCartMessage" name ="addToCartMessage"></p>
...
<div data-id="1844346307" class="product-1844346307 product-item">
   ...
   <div class="col-sm-6 col-lg-5 product-image">
                  ...
                  <?php
                    if($imageTag == 'F'){
                      echo "
                      <img src='asset/images/no-product.jfif' alt='Artica Nested Table'  id='product-featured-image' style = 'height:250px'/>";

                    }else{
                      echo "<a href='".$productImage."' class='cloud-zoom' id='zoom1' rel='useWrapper: false, adjustY:0, adjustX:20'>
                      <img src='".$productImage."' alt='Artica Nested Table'  id='product-featured-image'/></a>";
                    }
      ...
      <div class="col-lg-7 col-sm-6">
          ...
          <?php
            echo "<h1 itemprop='name' class='product_title page_title'>$productName </h1>";
          ?>
 

          
         
          <form action="" method="post" enctype="" name = "myform" id = "myform" data-id="1844346307" class="addToCartForm product-actions-1844346307">
            <div class="options clearfix"> 
              <p style= "font-size:20px">Brand: <span style = "color:blue; text-transform: capitalize"><?php echo $brandName?></span></p>
              <div id="product_price"><p class="price product-price" style = "color:red">&#8358; <?=number_format($productPrice)?></p>  </div> 
              ...
              <?php 
                ...
                echo "<button class='btn btn-primary add-to-cart-btn' title='Add to Cart' type='button' name='$productId~$pagename' id='add-to-cart' value='' onclick= 'addItemCart(this.name)'><span>Add to Cart</span></button>";
              ?>
               <!-- $productId$pagename -->
  ...
  <ul class="tabs">
    <li> 
      ...
      <a href="#tab-1" style = "background-color:black">Product Description</a>
...
<script src="../cdn/shop/t/2/assets/cloud-zoom1cf7.js?v=89117528290539160361449141650" type="text/javascript"></script>
