...
<div class="row mob-header">
  ...
  <div class="col-lg-7 col-sm-4 col-md-6 col-xs-12 top_search">   
        ...
        <div class="tile_search trs_bg" style = "padding-bottom:20px">
          <!-- search form -->
              <form id="" class="search-form" action="femaleSearch.php" method="POST">
                  <input id="search" type="text" name="search" value = "" placeholder="search here" />
                  <!-- <input type="text"> -->
...
<div class="grid grid-border header_product col-md-12" style = "text-align:center">
  ...
  <!-- <div class="grid-item large--four-fifths grid-border--left"> -->
      ...
      <h1 style = "text-align:center; color: black; font-size: 30px; font-style: italic; font-weight: bold; font-family: georgia,sans-serif;padding-top: 20px; margin-left: 50px" class = "header_product">Search Female Products</h1>
  ...
  $(function() {
    ...
    <?php
      ...
      if(isset($_POST["search"]) && !empty($_POST["search"])){
        ...
        $userInput = mysqli_real_escape_string($connection, $_POST["search"]); 
        $sql = "SELECT * FROM female_products WHERE product_name  LIKE '%$userInput%' OR brand_name LIKE '%$userInput%' OR product_description LIKE '%$userInput%' ORDER BY product_id DESC";
                ...
                echo "<div class='product product__product-grid-item col-sm-3'>
                  ...
                  if($imageTag == 'F'){
                    echo "<a href='".$productUrl."' class='product-grid-image'>
                      <img src='asset/images/no-product.jfif' alt='Black Slim Tapered Fit Track Pants' style = 'height: 250px'>
                
                    </a>";
                  }else{
                    echo "<a href='".$productUrl."' class='product-grid-image'>
                        <img src='".$productImage."' style = 'height: 250px'>
                      </a>";
                  }     
                  echo "</div>
        ...
        echo "<div class='col-sm-4 col-lg-4 product-image'>
                <div class='large-image'>      
                      ...
                      <h2 style = 'text-align:center;font-style:italic;'>Product does not exist</h2>
                </div>
              </div>";
        ...
        echo "<div class='col-sm-4 col-lg-4 product-image'>
                <div class='large-image'>      
                      <img src='asset/images/no-product.jfif' alt='Artica Nested Table'  id='product-featured-image' style = 'height:220px;width:400px'/></a>
                      <h2 style = 'text-align:center;font-style:italic;'>No product searched</h2>
                </div>
              </div>";
      }
    ?>
...
<!-- footer -->
<footer id="footer" style = "background-color:black; padding-bottom:40px;height:160px">
