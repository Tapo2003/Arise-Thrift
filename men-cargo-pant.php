...
<div class="grid grid-border header_product" style = "text-align:center">
  ...
  <!-- <div class="grid-item large--four-fifths grid-border--left"> -->
      ...
      <h1 style = "text-align:center; color: black; font-size: 30x; font-style: italic; font-weight: bold; font-family: georgia,sans-serif;padding-top: 20px; margin-left: 50px" class = "header_product">MEN CARGO PANTS</h1>
...
<script>
  ...
  $(function() {
    ...
    $sql = "SELECT * FROM male_products WHERE product_categories = 'men cargo pants' ORDER BY product_id DESC";
    ...
    while($row = mysqli_fetch_array($result)){
      ...
      $pagename = $pagename[count($pagename) - 1];
        ...
        if($numRow > 0){
            ...
            <form action='https://inspire-17.myshopify.com/cart/add' method='post' enctype='multipart/form-data' class='addToCartForm1'>
