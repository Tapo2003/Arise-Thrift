...
<div class="grid grid-border header_product" style = "text-align:center">
  ...
  <!-- <div class="grid-item large--four-fifths grid-border--left"> -->
    ...
    <h1 style = "text-align:center; color: black; font-size: 30px; font-style: italic; font-weight: bold; font-family: georgia,sans-serif;padding-top: 20px; margin-left: 50px" class = "header_product">BUM SHORTS</h1>
...
<script>
  ...
  $(function() {
    ...
    <?php
      ...
      $sql = "SELECT * FROM female_products WHERE product_categories = 'bum shorts' ORDER BY product_id DESC";
      ...
      if($defaultNum == 0){
       ...
       while($row = mysqli_fetch_array($result)){
           ...
           if($numRow > 0){
             ...
             <span class='shopify-product-reviews-badge' data-id='1844366787'></span>
