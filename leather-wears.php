...
<div class="grid grid-border header_product" style = "text-align:center">
  ...
  <h1 style = "text-align:center; color: black; font-size: 30px; font-style: italic; font-weight: bold; font-family: georgia,sans-serif;padding-top: 20px;" class = "header_product">LEATHER WEARS</h1>
...
<script>
  ...
  $(function() {
    ...
    <?php
      ...
      $sql = "SELECT * FROM female_products WHERE product_categories = 'leather wears' ORDER BY product_id DESC";
