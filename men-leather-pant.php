...
<div class="grid grid-border header_product" style = "text-align:center">
  ...
  <h1 style = "text-align:center; color: black; font-size:30px; font-style: italic; font-weight: bold; font-family: georgia,sans-serif;padding-top: 20px; margin-left: 50px" class = "header_product">MEN LEATHER PANT</h1>
...
<script>
  ...
  $(function() {
    ...
    <div class="grid-uniform">   
      ...
      $sql = "SELECT * FROM male_products WHERE product_categories = 'men leather pants' ORDER BY product_id DESC";
