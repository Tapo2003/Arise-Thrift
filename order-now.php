...
<?php 
    ...
    if($recordCount > 0){
        ...
        while($row = mysqli_fetch_array($result)){
            ...
            // $checking = ($price_total += $total_price);
...
?>
 <div id="main_content" class="col-main col-sm-12">
    ...
    <h2 style = "text-align:center">TOTAL PRICE : <span style = "color:blue;font-size:25px">&#8358;
        ...
        <div class="row-fluid">
            <div class="span6">
                <div id="customer" style = "border:solid 2px black">
                    <div class="template_header">
                        <h2 class="page_title" style = "font-size:20px;text-align:center    ">Customer Credentials</h2>
                    </div>
                    ...
                    <div>
                        <form id = "paymentForm">      
                            <div class="row">
                                ...
                                <input class="form-control" type="email" id = "email" name= "email" value="" class="large" size="30" />
                                <input class="form-control" type="hidden" id = "amount" name = "amount" value="<?=$sub_total?>"/>
                            </div>
                            </div>        
                            <div class="row">
                                <div id="login_password" class="col-sm-12 clearfix large_form control-group">
                                <label for="customer_password" class="login control-label">Firstname</label>
                                <input class="form-control" type="" id = "fname" name = "fname" value="" name="customer[password]" id="customer_password" class="large password" size="16" />
                            </div>
                            </div>
                            <div class="row">
                                <div id="login_password" class="col-sm-12 clearfix large_form control-group">
                                <label for="customer_password" class="login control-label">Lastname</label>
                                <input class="form-control" type="" value="" name="lname"  id="lname" class="large password" size="16" />
                            </div>
                            </div><br>

                            <div class="row">
                                <div id="login_password" class="col-sm-12 clearfix large_form control-group">
                                <label for="customer_password" class="login control-label">Phone number</label>
                                <input class="form-control" type="number" value="" name="phone"  id="phone" class="large password" size="16" />
                            </div>
                            </div><br>
                            ...
                            <div class="action_bottom">
                                <input class="btn btn-primary" type="submit" value="Order Now" style = "background-color:black; color: white" onclick= "payWithPaystack()"/>

                                <a href = "productCart.php" class="btn btn-primary" type="submit" value="Edit" style = "background-color:green; color: white">Edit</a>
        ...
        <script>
            ...
            if(email == '' || firstname == '' || lastname == '' || phone == ''){
              ...
              let handler = PaystackPop.setup({
                  ...
                  ref: 'Arise'+Math.floor((Math.random() * 1000000000) + 1),
                  ...
                  window.location = "http://localhost/Arise%20Thrift/verify-transaction.php?reference=" + response.reference;
                  }
              });
              handler.openIframe();
              }
...
jQuery("#brand-logo-slider .slider-items").owlCarousel({
 ...
 itemsMobile : [320,1],
 navigation : true,
 navigationText : ["<a class=\"flex-prev\" style = \"visibility:hidden\"></a>","<a class=\"flex-next\" style = \"visibility:hidden\"></a>"],
 slideSpeed : 500,
 pagination : false   
});
