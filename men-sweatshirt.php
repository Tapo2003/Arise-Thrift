...
<div class="row mob-header">
  ...
  <div class="col-lg-7 col-sm-4 col-md-6 col-xs-12 top_search">   
        ...
        <div class="tile_search trs_bg" style = "padding-bottom:20px">
          <!-- search form -->
          <form id="search" name = "search" class="search-form" action="maleSearch.php" method="POST">
                  <input id="search" type="text" name="search" placeholder="search here" />
                <button type="submit" title="Search" class="search-btn-bg" id="submit-button" style = "background-color:black"><span>search</span></button>
...
<div class="grid grid-border header_product" style = "text-align:center">
  ...
  <h1 style = "text-align:center; color: black; font-size: 30px; font-style: italic; font-weight: bold; font-family: georgia,sans-serif;padding-top: 20px;margin-left: 50px" class = "header_product">MEN SWEATSHIRT</h1>
...
$sql = "SELECT * FROM male_products WHERE product_categories = 'men sweatshirts' ORDER BY product_id DESC";
