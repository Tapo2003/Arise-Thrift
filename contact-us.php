...
?>
 <div id="main_content" class="col-main col-sm-12">
    <div id="template" class="customer customer__login" >
            ...
            <div class="span6">
                <div id="customer" style = "border:solid 2px black">
                    <div class="template_header">
                        <h2 class="page_title" style = "font-size:20px;text-align:center    ">Contact Us</h2>
                    </div>
                    ...
                    <div>
                        <form id = "paymentForm">      
                            ...
                            <div class="row">
                                ...
                                <label for="customer_password" class="login control-label">Name</label>
                                <input class="form-control" type="" value="" name="name"  id="name" class="large password" size="16" />
                            </div>
                            </div><br>
                            ...
                            <div class="row">
                                <div id="login_password" class="col-sm-12 clearfix large_form control-group">
                                  <label>Message:</label>
                                  <textarea class="form-control" rows="10" cols="75" id="message" name="message" placeholder="Your Message..."></textarea>
                                </div>
                            </div><br>
                            <div class="action_bottom">
                                <input class="btn btn-primary" type="submit" value="Contact Us" style = "background-color:black; color: white" onclick= "contact()"/>
        ...
        <script>
          paymentForm.addEventListener("submit", contact, false);
          function contact(e){
            ...
            var message = $("#message").val();
              ...
              if(name == '' || email == '' || phone == '' || message == ''){
                ...
                var response = confirm("Are you sure you want to contact us ?");
                if(response == true){
                  var formData = $("form#paymentForm").serialize();
                  $.ajax({ 
                    type:"POST",
                    url: "processContactUs.php",     
                    data:formData,
                    success:function(returnData){	
                      if(returnData == 1){
                        alert("You have successfully contacted us, we would get back to you");
                        ClearFields();
                      }else if(returnData == 3){
                        alert('You have contacted us already');
                        ClearFields();
                        // $("#name").focus();
                      }
                  }
